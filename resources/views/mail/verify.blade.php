                                                        ...
                                                        <td data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit data-text-edit>
                                                                    ...
                                                                    <br><br>
                                                                    Welcome to Speakede! To get started, please verify your email address by clicking the link below:

                                                                    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"> Verification link  <a href="{{ $details['link'] }}" style="color: #0a58ca"> Click here</a></span></p>
                                                                    <br>
                                                                    <p>Thanks for joining our community of language learners and culture enthusiasts.</p>
                                                                    <br />
                                                                    <p>Best regards,</p>
                                                                    <p>The Speakede Team</p>
                                                                </div>
                                                            </singleline>
                                                        </td>
                                                    </tr>
