                                                        ...
                                                        <td data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit data-text-edit>
                                                                    ...
                                                                    <br><br>
                                                                    Great news! A learner has booked your private session "{{ucwords($details['session_name'])}}" on Speakede.
                                                                    <br>
                                                                    <br>
                                                                    ...
                                                                    <br>
                                                                    <p>Thank you for being a part of our immersive language-learning experience.</p>
                                                                    <br />
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="left">
                                                    <tr>
                                                        <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Header Button" data-bgcolor="Header Button" bgcolor="#24A19C" style="border-radius: 0px;">
                                                            ...
                                                            <![endif]-->
                                                            {{--                                                            <singleline>--}}
{{--                                                                <a href="#" mc:edit data-button data-text-style="Header Button" style="font-family:'IBM Plex Sans Thai Looped',Arial,Helvetica,sans-serif;font-size:18px;line-height:28px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 16px 34px 16px 34px;display: inline-block;"><span>Join us</span></a>--}}
{{--                                                            </singleline>--}}
                                                            <!--[if (gte mso 9)|(IE)]>
                                                            </td>
                                                            <td align="center" width="34"></td>
