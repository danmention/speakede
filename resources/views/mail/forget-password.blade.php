...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
        <td align="center" data-bgcolor="Body" bgcolor="#FAEEE7" data-composer>
            ...
            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row container-padding"
                   role="presentation" width="640" style="width:640px;max-width:640px;" data-module="freya-header-6">
                <!-- freya-header-6 -->
                <tr>
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <!-- <tr data-element="freya-header-image" data-label="Header image">
                                          <td align="center" class="img-responsive">
                                            <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" data-image-edit data-url data-label="Header image" width="580" src="images/header-6.jpg" border="0" editable="true" alt="picture">
                                          </td>
                                        </tr> -->
                                        <tr data-element="freya-header-image" data-label="Header image">
                                        ...
                                        <tr data-element="freya-header-message-arrow" data-label="Arrow icon">
                                            <td align="left">
                                                <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/arrow-chat.png')}}" width="24" border="0" editable="true" data-icon data-image-edit data-url data-label="Arrow" data-image-width alt="arrow">
                                            </td>
                                        </tr>
                                        <tr data-element="freya-header-message-container" data-label="Message Container">
                                            <td align="center" bgcolor="#F8F8F8" data-bgcolor="Message BgColor">
                                                <!-- column -->
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="93.1%" style="width:93.1%;max-width:93.1%;">
                                                    <tr>
                                                        <td height="20" style="font-size:20px;line-height:20px;">&nbsp;</td>
                                                    </tr>
                                                    <tr data-element="freya-invitation-message-paragraph" data-label="Paragraphs">
                                                        <td data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit data-text-edit>


                                                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px;">Hello,{{ucwords($details['name'])}}, </span></p>
                                                                        <br />
                                                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Your verification code </span></p>

                                                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">{{ucwords($details['code'])}} </span></p>

                                                                        <br />
                                                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">To reset your Speakede password, click the link below:</span></p>
                                                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"> Verification link  <a href="{{ $details['link'] }}"> Click here</a></span></p>
                                        ...
                                        <tr data-element="freya-header-message-container" data-label="Message Container">
                                            <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under message container">&nbsp;</td>
                                        </tr>
                                        <tr data-element="freya-header-button" data-label="Header Button">
                                            <td align="center">
                                                <!-- Button -->
            ...
            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="freya-footer">
                <!-- freya-footer -->
                <tr>
                    <td align="center">
                        ...
                        <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
                            <tr>
                                <td height="120" style="font-size:120px;line-height:120px;" data-height="Spacing top">&nbsp;</td>
                            </tr>
                            <tr data-element="freya-footer-links" data-label="Footer Links">
                                <td align="center">
                            ...
                            <tr data-element="freya-footer-links" data-label="Footer Links">
                                <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under footer links">&nbsp;</td>
                            </tr>
                            <tr data-element="freya-footer-social-icons-contact" data-label="Social Icons & Contact">
                                <td align="center">
                                    <!-- rwd-col -->
                                    <table border="0" cellpadding="0" cellspacing="0" align="center" role="presentation" class="container-padding" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td class="rwd-col" align="center" width="41.38%" style="width:41.38%;max-width:41.38%;">

                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" align="left" class="center-float">
                                                    <tr class="center-on-mobile">
                                                        <td data-element="freya-footer-facebook" data-label="Facebook" align="left" valign="middle">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td align="center">
                                                                        <a href="https://www.facebook.com/speakede">
                                                                            <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/facebook.png')}}" width="24" border="0"
                                                                                 editable="true" data-icon data-image-edit data-url data-label="Facebook" data-image-width alt="Facebook">
                                                                        </a>
                                                                    </td>
                                                                    <td width="6"></td>
                                                                </tr>
                                                        ...
                                                        <td data-element="freya-footer-linkedin" data-label="Linkedin" align="center" valign="middle">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="6"></td>
                                                                    <td align="center">
                                                                        <a href="https://twitter.com/speakede">
                                                                            <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/twitter.png')}}" width="24" border="0" editable="true" data-icon data-image-edit data-url data-label="Linkedin" data-image-width alt="Linkedin">
                                                                        </a>
                                                                    </td>
                                                                    <td width="6"></td>
                                                                </tr>
                                                        ...
                                                        <td data-element="freya-footer-linkedin" data-label="Linkedin" align="center" valign="middle">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="6"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.linkedin.com/in/speakede/">
                                                                            <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/linkedin.png')}}" width="24" border="0" editable="true" data-icon data-image-edit data-url data-label="Linkedin" data-image-width alt="Linkedin">
                                                                        </a> </td>
                                                                    <td width="6"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td data-element="freya-footer-instagram" data-label="Instagram" align="center" valign="middle">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="6"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.instagram.com/speakede">
                                                                            <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/instagram.png')}}" width="24" border="0" editable="true" data-icon data-image-edit data-url data-label="Instagram" data-image-width alt="Instagram">
                                                        ...
                                                        <td data-element="freya-footer-YouTube" data-label="YouTube" align="center" valign="middle">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="6"></td>
                                                                    <td align="center">
                                                                        <img style="width:24px;border:0px;display: inline!important;" src="{{asset('images/youtube.png')}}" width="24" border="0" editable="true" data-icon data-image-edit data-url data-label="YouTube" data-image-width alt="YouTube">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                            ...
                                            <td class="rwd-col" align="center" width="1.62%" height="20" style="width:1.62%;max-width:1.62%;height:20px;">&nbsp;</td>
                                            <td class="rwd-col" align="center" width="57%" style="width:57%;max-width:57%;">

                                                <table border="0" cellpadding="0" cellspacing="0" align="right" role="presentation" class="center-float">
                                                    <tr class="center-on-mobile">
                                                        <td data-element="freya-footer-email" data-label="Email" class="rwd-on-mobile row" align="center" valign="middle">
                                                            <!-- Links -->
                                                            <table border="0" cellspacing="0" cellpadding="0" class="center-float">
                                                                <tr>
                                                                    <td align="center">
                                                                        <singleline>
                                                                            <a href=""  mc:edit data-button data-text-style="Links" style="font-family:'IBM Plex Sans Thai Looped',Arial,Helvetica,sans-serif;font-size:12px;line-height:28px;font-weight:500;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;"><span>info@speakede.com</span></a>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr data-element="freya-footer-social-icons-contact" data-label="Social Icons & Contact">
                                <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under social icons & contact">&nbsp;</td>
                            </tr>
                            <tr data-element="freya-footer-copyrights-apps" data-label="Copyrights & Apps">
                                <td align="center">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" align="center" role="presentation" class="container-padding" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td class="rwd-col" align="center" width="51.72%" style="width:51.72%;max-width:51.72%;">

                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" align="left" class="center-float">
                                                    <tr data-element="freya-footer-paragraph" data-label="Paragraphs">
                                                        <td data-text-style="Paragraphs" align="left" class="center-text" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:12px;line-height:24px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                                                            <singleline>
                                                                <div mc:edit data-text-edit>
                                            ...
                                            <td class="rwd-col" align="center" width="3.45%" height="20" style="width:3.45%;max-width:3.45%;height:20px;">&nbsp;</td>
                                            <td class="rwd-col" align="center" width="44.83%" style="width:44.83%;max-width:44.83%;">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float">
                                                                <tr data-element="freya-footer-icon" data-label="Buttons">
                                                                    <td align="center">
                                                                        <img style="display:block;width:100%;max-width:117px;border:0px;" data-image-edit data-url data-label="App Store" width="117" src="{{asset('images/App-Store.png')}}" border="0" editable="true" alt="icon">
                                                                    </td>
                                                                    <td width="10" style="width: 10px;"></td>
                                                                    <td align="center">
                                                                        <img style="display:block;width:100%;max-width:117px;border:0px;" data-image-edit data-url data-label="Google play" width="117" src="{{asset('images/Google-play.png')}}" border="0" editable="true" alt="icon"></td>
                                                                </tr>
                                                            </table>
                                                            <!-- column -->
                                                        </td>
                            ...
                            <tr data-element="freya-footer-copyrights-apps" data-label="Copyrights & Apps">
                                <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing under copyrights & apps">&nbsp;</td>
                            </tr>
                        </table>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                            ...
                            <tr data-element="freya-footer-tags" data-label="Footer Tags">
                                <td align="center" bgcolor="#FFFFFF" data-bgcolor="Footer BgColor">
                                    ...
                                    <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
                                        <tr>
                                            <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing under brand colors">&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under tags">&nbsp;</td>
                                        </tr>
                                    </table>
