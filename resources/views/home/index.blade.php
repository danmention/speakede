            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="hero-content">
                        <h2 class="title">First <span>ethnic language </span> social platform</h2>
                        <p>For language lovers, culture enthusiasts and global citizens looking to connect with <br /> others and express themselves freely in any language!</p>
            ...
            <div class="category-wrap">
                <div class="row">
                    <div class="section-title text-center">
                        <h2 class="title">Top <span>languages</span></h2>
                    </div>
                </div>
...
{{--                            <li><button class="active" data-bs-toggle="tab" data-bs-target="#tab1">Javascript</button></li>--}}
                            <li><button data-bs-toggle="tab" data-bs-target="#tab{{$x++}}">{{$row->title}}</button></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                        ...
                        <div class="tab-pane fade" id="tab2">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-1.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
                                            ...
                                            <h3 class="title"><a href="{{url('teacher/9109019/english')}}">Getting Started with the Linux Command Line</a></h3>
                                            <div class="courses-meta">
                                                <p class="author-name"><span>By</span> Andrew paker</p>
                                                <div class="rating">
                                                    <div class="rating-star">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        ...
                                        <div class="courses-content">
                                            ...
                                            <h3 class="title"><a href="{{url('teacher/9109019/english')}}">Build A Full Web Chat App From Scratch</a></h3>
                                            <div class="courses-meta">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-4.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-5.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-6.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-7.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
                                            ...
                                            <h3 class="title"><a href="{{url('teacher/9109019/english')}}">The Complete Web Developer Course</a></h3>
                                            <div class="courses-meta">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="single-course">
                                        <div class="courses-image">
                                            <a href="{{url('teacher/9109019/english')}}"><img src="{{asset("home/assets/images/courses/courses-8.jpg")}}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                            <div class="top-meta">
                                                <div class="tag-time">
    ...
    <div class="section upstudy-counter-section section-padding-02" style="background-image: url({{asset("home/assets/images/bg/counter-bg.png")}}")}});">
        ...
        <div class="shape-2">
            <img src="{{asset("home/assets/images/shape/counter-shape2.png")}}" alt="">
        </div>
        <div class="shape-3">
            <img src="{{asset("home/assets/images/shape/counter-shape3.png")}}" alt="">
        </div>
        <div class="container">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide single-testimonial-content">
                                ...
                                <h3 class="title">Meet people from around the globe</h3>
