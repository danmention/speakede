...
<a href="{{url('online-sessions/'.$row->url)}}">
    <div class="single-course" style="background-color:#ffffff;box-shadow: 0 33px 73px 0 rgba(0, 0, 0, 0.1);border-radius: 20px;">
    <div class="courses-image" style="background-image: url('{{asset('group/class/photo/'.$row->user_id.'/'.$row->cover_image)}}');
    width: 305px; height: 218px; background-size: cover; background-repeat: no-repeat">
    </div>
