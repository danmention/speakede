                ...
                <div class="col-md-6 col-xl-5">
                    ...
                    <div class="block block-rounded h-100 mb-0">
                        ...
                        <div class="block-content block-content-full bg-body-light text-center">
                            <h4 class="fs-sm text-muted mb-0">Online Meeting (ZOOM)</h4>
                        </div>
                        <div class="block-content text-center">
                            <h3>₦ {{number_format($preferred_lang[0]->price)}}</h3>
                                ...
                                @else
                                    <div class="col-6">
                                        <form role="form" method="post" class="validate" action="{{ route('user.schedule.booking') }}" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="amount" value="{{$preferred_lang[0]->price}}">
