                                ...
                                <table
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                            aria-label="Name: activate to sort column ascending">User 1
                                        </th>
                                        <th class="d-none d-sm-table-cell sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                            rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">User 2
                                        </th>
                                        <th class="d-none d-sm-table-cell sorting" style="width: 15%;" tabindex="0"
                                            aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                            aria-label="Access: activate to sort column ascending">Description
                                        </th>
                                        <th class="text-center sorting" style="width: 15%;" tabindex="0"
                                            aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                            aria-label="Profile: activate to sort column ascending">Meeting Time
                                        </th>

                                        <th class="text-center sorting" style="width: 15%;" tabindex="0"
                                            aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                            aria-label="Profile: activate to sort column ascending">Meeting Duration
                                        </th>

                                        <th class="text-center sorting" style="width: 15%;" tabindex="0"
                                            aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                            aria-label="Profile: activate to sort column ascending">Meeting Link
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    @foreach($data as $row)
                                        <tr class="odd">
                                            ...
                                            <td class="fw-semibold">{{$row->fullname1}}</td>
                                            <td class="d-none d-sm-table-cell"> {{$row->fullname2}}</td>
                                            <td class="d-none d-sm-table-cell">{{$row->zoom_response["agenda"]}}</td>
                                            <td class="d-none d-sm-table-cell">{{$row->zoom_response["start_time"]}}</td>
                                            <td class="d-none d-sm-table-cell">{{$row->zoom_response["duration"]}} mins</td>
                                            <td class="d-none d-sm-table-cell"> <a href="{{$row->zoom_response["start_url"]}}" target="_blank">Meeting Link</a></td>
                                        </tr>
                                    @endforeach
